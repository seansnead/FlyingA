...
<head>
  ...
  <title>Flying A Construction – Land Clearing & Ranch Services</title>
...
<body>
  ...
  <section class="hero">
    ...
    <p class="hero-sub">Land clearing, ranch prep, and everything in between — done right, done local.</p>
  ...
  <div class="services-strip" aria-hidden="true">
    <div class="strip-inner">
      LAND CLEARING <span>✦</span>
      BRUSH REMOVAL <span>✦</span>
      FENCE LINE CLEARING <span>✦</span>
      SITE PREPARATION <span>✦</span>
      POND WORK <span>✦</span>
      ROAD GRADING <span>✦</span>
      TREE REMOVAL <span>✦</span>
      PASTURE CLEARING <span>✦</span>
      LAND CLEARING <span>✦</span>
      BRUSH REMOVAL <span>✦</span>
      FENCE LINE CLEARING <span>✦</span>
      SITE PREPARATION <span>✦</span>
  ...
  <section class="about" id="about">
    <div class="about-text">
      ...
      <p class="section-body">
        Flying A Construction is a locally owned and operated outfit serving ranchers and landowners across small-town Texas. We know this land because it's our land — and we bring the equipment, experience, and work ethic to get the job done without the runaround.
      </p>
    ...
    <div class="why-points">
      <div class="why-point">
        ...
        <div class="why-text">
          ...
          <p>We live here, work here, and care about this community. You'll deal directly with the owner — no middlemen, no call centers.</p>
        </div>
      </div>
      <div class="why-point">
        ...
        <div class="why-text">
          ...
          <p>We run well-maintained machines suited for Texas terrain — from thick cedar country to rocky hillside properties.</p>
        </div>
      </div>
      <div class="why-point">
      ...
      <div class="why-point">
        ...
        <div class="why-text">
          ...
          <p>We respect your time and your land. When we say we'll be there, we'll be there — and we don't leave until the job is finished right.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="contact" id="contact">
    ...
    <p class="contact-note">Mon – Sat &nbsp;·&nbsp; We answer when we can, call back fast when we can't</p>
  </section>
